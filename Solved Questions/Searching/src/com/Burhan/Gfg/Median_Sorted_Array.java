...
public class Median_Sorted_Array {
    public static void main(String[] args) {
        ...
        // float[] arr2 = {5,15,25,35,45};
        // float[] arr1 = {1,3,5,15,17};
        // float[] arr2 = {2,8,10,12,20};
        float ans = MedianArray(arr1, arr2);
        System.out.print(ans);
    }

    static float MedianArray(float[] arr1, float[] arr2) {
        ...
        if ((mix.length-1)%2==0) {
            ...
            int mid = (0+mix.length-1)/2;
            return (mix[mid]+mix[mid+1])/2;
        }
    }

    static float[] mergeArray(float[] arr1, float[] arr2) {
